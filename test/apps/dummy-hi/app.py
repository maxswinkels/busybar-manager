#!/usr/bin/env python3
"""Dummy high-priority test app for busybar-manager e2e tests.
...
def parse_args():
    p = argparse.ArgumentParser(description="Dummy test app (high priority)")
    p.add_argument("--host", default="10.0.4.20")
    p.add_argument("--text", default="HI", help="text to draw (default: HI)")
    return p.parse_args()
